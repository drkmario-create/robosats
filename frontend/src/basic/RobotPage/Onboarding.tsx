        ...
        <AccordionDetails>
          <Grid container direction='column' alignItems='center' spacing={1} padding={1.5}>
            <Grid item>
              <Typography>
                {t(
                  'DimBR is a peer-to-peer marketplace. You can browse the public offers or create a new one.',
                )}
              </Typography>
            </Grid>
            ...
            <Grid item>
              <Typography>
                {`${t('If you need help on your DimBR journey join our public support')} `}
                <Link
                  target='_blank'
